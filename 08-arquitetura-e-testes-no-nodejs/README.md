...
Nessa aula, reestruturamos a arquitetura do nosso backend criado na aula 04 ([Iniciando back-end do app](https://github.com/thiagocdn/aulas-bootcamp-GoStack11-rocketseat/tree/master/04-iniciando-back-end)).
